---
{"tags":["Topology"],"dg-publish":true,"dg-path":"I. Teaching/Mathematics/Cardinal Functions of Topological Spaces","permalink":"/i-teaching/mathematics/cardinal-functions-of-topological-spaces/","dgPassFrontmatter":true,"noteIcon":"1","created":"2026-02-08T18:42:15.000-10:00","updated":"2026-06-28T12:50:59.746-10:00"}
---
...
**Obs:** If we have that $\chi(X, \tau) \le \aleph_0$ then we note that this equivalent to the space being [[charleshoots.net/I. Teaching/Mathematics/Separable, First and Second Countable Spaces\|first countable]]. If we have that $w(X, \tau) \le \aleph_0$ this is equivalent to the space being [[charleshoots.net/I. Teaching/Mathematics/Separable, First and Second Countable Spaces\|second countable]]. 
...
**Th:** For every [[charleshoots.net/I. Teaching/Mathematics/Kolmogorov Spaces\|Kolmogorov space]] we have $|X| \le 2^{w(X)}$.   
...
**Cor:** If $X$ is a [[charleshoots.net/I. Teaching/Mathematics/Normal Hausdorff Spaces\|normal space]], $M$ is dense in $X$ and $A \subseteq M$, then $\chi(A, M) = \chi(A, X)$. 
...
**Th:** For every [[charleshoots.net/I. Teaching/Mathematics/Hausdorff Spaces\|Hausdorff space]] we have that $|X| \le 2^{2^{d(X)}}$ and $|X| \le [d(X)] ^{\chi(X)}$.

**Th:** For every [[charleshoots.net/I. Teaching/Mathematics/Regular Hausdorff spaces\|regular Hausdorff space]] we have $w(X) \le 2^{d(X)}$.
...
**Th:** For every [[charleshoots.net/I. Teaching/Mathematics/Kolmogorov Spaces\|Kolmogorov space]] we have $|X| \le 2^{nw(X)}$.   
