---
{"tags":["Analysis"],"dg-publish":true,"dg-path":"I. Teaching/Mathematics/Continuous Function Spaces","permalink":"/i-teaching/mathematics/continuous-function-spaces/","dgPassFrontmatter":true,"noteIcon":"1","created":"2026-02-08T18:42:15.000-10:00","updated":"2026-06-28T12:51:06.011-10:00"}
---
...
$$
Meaning that this is the most well behaved. If we have that $Y$ is a normed space then any ${\cal C}^0(X, Y)$ is also a normed space, and we usually endow it with the uniform norm, or uniform metric as the [[charleshoots.net/I. Teaching/Mathematics/Bounded Function Spaces\|Bounded Function Spaces]]
...
One important characteristic to note about ${\cal C}^0_p[a,b]$ is that for $p < \infty$, then ${\cal C}^0_p[a,b]$ it is not complete, and the [[charleshoots.net/I. Teaching/Mathematics/Completion of a Metric Space\|completion]] of this space is actually closely related to the [[Lp spaces\|Lp spaces]] 