...
**Def:** Let $f:U\subseteq\Bbb R^3\to\Bbb R$ be $\cal C^2$on $U$, if $\Delta f =0$, then $f$ is called [[charleshoots.net/I. Teaching/Mathematics/Harmonic Functions\|harmonic]].