...
We can look at the [[charleshoots.net/I. Teaching/Mathematics/Normal Subgroups and Quotient Groups\|quotient group]] $\Bbb R/\Bbb Z$, then we can consider that tag each $x + \Bbb Z$, with the representative $\{x\}$.
...
We can also solve [[charleshoots.net/I. Teaching/Mathematics/The Heat Equation on the Circle\|The Heat Equation on the Circle]]