...
Links: [[charleshoots.net/I. Teaching/Mathematics/The Cotangent Bundle\|The Cotangent Bundle]], [[charleshoots.net/I. Teaching/Mathematics/Covector Fields on Smooth Manifolds\|Covector Fields on Smooth Manifolds]], [[charleshoots.net/I. Teaching/Mathematics/Local and Global Sections of Vector Bundles\|Local and Global Sections of Vector Bundles]], [[charleshoots.net/I. Teaching/Mathematics/Exterior Algebra of Vector Spaces\|Exterior Algebra of Vector Spaces]], [[charleshoots.net/I. Teaching/Mathematics/The Dual Functor and the Multicovector Functor\|The Dual Functor and the Multicovector Functor]], [[charleshoots.net/I. Teaching/Mathematics/The Tensor Bundles\|The Tensor Bundles]], [[charleshoots.net/I. Teaching/Mathematics/Derivations\|Derivations]]
...
- $i_X: \Omega^k (M) \to \Omega^{k-1}(M)$ is linear over $\mathcal C^\infty(M)$ and therefore corresponds to a [[charleshoots.net/I. Teaching/Mathematics/Bundle Homomorphisms for Vector Bundles\|smooth bundle homomorphism]] $i_X: {\textstyle \bigwedge}^{\!k}(T^*M) \to {\textstyle \bigwedge}^{\!k-1}(T^*M)$. 

An important operation to differential forms is the [[charleshoots.net/I. Teaching/Mathematics/The Exterior Derivative on Smooth Manifolds\|exterior derivative]]
