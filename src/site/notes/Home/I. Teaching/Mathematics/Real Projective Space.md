...
**Prop:** The equivalence relation $\sim$ on $\Bbb R^{n+1}\setminus\{0\}$ in the definition of $\Bbb {RP}^n$ is an open equivalence relation. This can be seen as the [[charleshoots.net/I. Teaching/Mathematics/Continuous Actions of Groups\|Continuous Actions of Groups]] (scalar multiplication) on the topological space $\Bbb R^{n+1}\setminus\{0\}$. 
