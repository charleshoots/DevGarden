...
We know that the rising and falling factorials are polynomials sequences of binomial type, bringing us to a connection to [[charleshoots.net/I. Teaching/Mathematics/Umbral calculus\|Umbral calculus]].
...
when $k =1$, then $\Gamma_k = \Gamma$, the [[charleshoots.net/I. Teaching/Mathematics/Gamma Function\|usual gamma function]]