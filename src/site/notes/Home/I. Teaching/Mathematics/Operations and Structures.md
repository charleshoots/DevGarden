...
$$
since we need a [[charleshoots.net/I. Teaching/Mathematics/Ordinal Numbers#The Transfinite Recursion Theorem, Parametric Version\|stronger recursion Theorem]]
## Structure types
...
Given a structure $\frak U$, we can consider the [[charleshoots.net/I. Teaching/Mathematics/Automorphism Group\|automorphism group]]. 
