---
{"cssclasses":"img-grid","dg-publish":true,"dg-path":"I. Teaching/Physics/Torque","permalink":"/i-teaching/physics/torque/","dgPassFrontmatter":true,"noteIcon":"1","created":"2025-09-14T21:09:34.000-10:00","updated":"2026-06-28T12:59:50.252-10:00"}
---
...
# Definition
Torque is the twisting force that enables an object to rotate. This is always needed for an object to experience a force to begin or continue rotation. It is defined as the [[Derivative\|derivative]] of [[Home/I. Teaching/Physics/Angular Momentum\|Angular Momentum]], which physically is the amount of twisting force at a point.


## Derivation 
> [!warning] Assumptions
To derive torque, assume the following:
> - [[Home/I. Teaching/Physics/Angular Momentum\|Angular Momentum]] is defined as $\vec{L} = \vec{r} \times \vec{p}$
...
> - Since the force is perpendicular by definition of [[Home/I. Teaching/Physics/Newton Laws\|newtons second law]] and [[Home/I. Teaching/Physics/Angular Acceleration\|Angular Acceleration]] $F_{\perp}=ma_{t}=mr\alpha$ 
> - The [[Home/I. Teaching/Physics/Moment of Inertia\|Moment of Inertia]] is defined as $I=mr^2$
