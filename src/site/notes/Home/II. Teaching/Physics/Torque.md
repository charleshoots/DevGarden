---
{"cssclasses":"img-grid","dg-publish":true,"dg-path":"II. Teaching/Physics/Torque","permalink":"/ii-teaching/physics/torque/","dgPassFrontmatter":true,"noteIcon":"1","created":"1984-01-23T22:00:00.000-10:00","updated":"2026-03-17T15:04:06.998-10:00"}
---
...
# Definition
Torque is the twisting force that enables an object to rotate. This is always needed for an object to experience a force to begin or continue rotation. It is defined as the [[Derivative\|derivative]] of [[Home/II. Teaching/Physics/Angular Momentum\|angular momentum]], which physically is the amount of twisting force at a point.


## Derivation 
> [!warning] Assumptions
To derive torque, assume the following:
> - [[Home/II. Teaching/Physics/Angular Momentum\|Angular momentum]] is defined as $\vec{L} = \vec{r} \times \vec{p}$
...
> - Since the force is perpendicular by definition of [[Home/II. Teaching/Physics/Newton Laws\|newtons second law]] and [[Home/II. Teaching/Physics/Angular Acceleration\|angular acceleration]] $F_{\perp}=ma_{t}=mr\alpha$ 
> - The [[Home/II. Teaching/Physics/Moment of Inertia\|moment of inertia]] is defined as $I=mr^2$
