---
{"tags":["FourierAnalysis","PartialDifferentialEquations"],"dg-publish":true,"dg-path":"II. Teaching/Mathematics/The Heat Equation on the Real line","permalink":"/ii-teaching/mathematics/the-heat-equation-on-the-real-line/","dgPassFrontmatter":true,"noteIcon":"1","created":"2026-02-08T18:42:15.000-10:00","updated":"2026-03-17T15:04:06.599-10:00"}
---
...
Just as in the case of [[charleshoots.net/II. Teaching/Mathematics/The Heat Equation on the Circle\|circle]] the solution is given in terms of a convolution. Indeed, define the *heat kernel* of the line by $$\mathcal H_t(x) = K_\delta(x), \qquad \text{with } \delta = 4\pi t$$so that $$\mathcal H_t(x) = \frac1{(4\pi t)^{1/2}}e^{-x^2/4t}\qquad \text{and} \quad \hat{\mathcal H_t}(\omega) = e^{-4\pi^2t\omega^2}$$
