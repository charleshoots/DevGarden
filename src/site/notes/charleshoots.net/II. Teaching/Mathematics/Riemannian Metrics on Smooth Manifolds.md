---
{"tags":["DifferentialGeometry"],"dg-publish":true,"dg-path":"II. Teaching/Mathematics/Riemannian Metrics on Smooth Manifolds.md","permalink":"/ii-teaching/mathematics/riemannian-metrics-on-smooth-manifolds/","dgPassFrontmatter":true,"noteIcon":"1","created":"2026-02-08T18:42:15.000-10:00","updated":"2026-02-09T11:03:47.176-10:00"}
---
...
**Def:** Suppose $\pi: N \to M$ is a smooth covering map. A *covering transformation*, or *[[charleshoots.net/II. Teaching/Mathematics/Automorphism Group of a Covering Map\|deck transformation]]* is a smooth map $\varphi: N \to N$ such that $\pi \circ \varphi = \pi$. If $g$ is Riemannian metric on $M$, then $h := \pi^* g$ is a Riemannian metric on $N$ that is invariant under all covering transformations. In this case $h$ is called a *covering metric*, and $\pi$ is called *Riemannian covering*. 

**Prop:** If $(M, g)$ is a Riemannian $n$-manifold with or without boundary, let $UM \subseteq TM$ be the subset $\{(x, v) \in TM \mid |v|_g = 1\}$, called the *unit tangent bundle of $M$*. Then  $UM$ is a smooth [[charleshoots.net/II. Teaching/Mathematics/Fibre Bundles on Smooth Manifolds\|fibre bundle]] over $M$ with model fibre $\Bbb S^{n-1}$. 