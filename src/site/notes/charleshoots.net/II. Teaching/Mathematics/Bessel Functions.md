---
{"dg-publish":true,"dg-path":"II. Teaching/Mathematics/Bessel Functions","permalink":"/II. Teaching/Mathematics/Bessel Functions/","tags":["SpecialFunctions","teaching","mathematics"],"noteIcon":"1","created":"2026-02-11T19:13:57.385-10:00","updated":"2026-02-11T20:25:22.719-10:00"}
---
...
The Bessel functions are canonical solutions $y(x)$ of [[../../II. Teaching/Mathematics/Important Differential Equations#ODE\|Bessel's differential equation]]: $$x^2 y'' + xy' (x^2-\alpha^2)y = 0$$
...
This integral representation can be interpreted as, the $n$th [[../../II. Teaching/Mathematics/Main definitions for Fourier Analysis\|Fourier coefficient]] of the function $e^{ix\sin\theta}$. So $$e^{ix\sin \theta} = \sum_{n = -\infty}^\infty J_n(x) e^{in\theta}$$
